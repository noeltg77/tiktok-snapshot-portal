...
interface HashtagSocialCardProps {
  author?: {
    name?: string;
    username?: string;
    avatar?: string;
...
export function HashtagSocialCard({
  author,
  content,
  engagement,
  onLike,
    ...
    >
      <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
        <div className="p-6">
          ...
          {/* Engagement section - All stats non-clickable except comments */}
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              {/* Like stat - Non-clickable and colored */}
              ...
              {/* Bookmark stat - Non-clickable and colored */}
